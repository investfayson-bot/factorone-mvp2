        ...
        <div style={card}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 12 }}>
            {[
              ...
              <div key={label}>
                <div style={{ fontSize: 10, color: 'var(--gray-400)', textTransform: 'uppercase', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>{label}</div>
      ...
      <div style={card}>
        ...
        <div className="expenses-table">
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
            <thead>
              <tr style={{ color: 'var(--gray-400)', fontSize: 10, textTransform: 'uppercase', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
              ...
              {notas.map((n) => {
                ...
                return (
                  <tr key={n.id} style={{ borderTop: '1px solid var(--gray-100)' }}>
                    ...
                    <td style={{ padding: '8px 0', color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>R$ {(n.valor_total || 0).toLocaleString('pt-BR')}</td>
