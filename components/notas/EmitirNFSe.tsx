  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      <div style={{ background: 'var(--navy)', borderRadius: 12, padding: 18, marginBottom: 14 }}>
        <div style={{ fontSize: 9.5, color: 'rgba(255,255,255,.5)', textTransform: 'uppercase', fontFamily: "'Manrope', 'Inter', sans-serif", marginBottom: 4 }}>Valor líquido (após retenções)</div>
