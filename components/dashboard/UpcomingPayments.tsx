            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 3, flexShrink: 0 }}>
                  <span style={{ fontSize: 12.5, fontWeight: 700, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
                    {fmtBRL(r.valor)}
                  </span>
                  <span style={{ fontSize: 9.5, fontWeight: 700, padding: '1px 7px', borderRadius: 20, fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", ...badgeStyle(dias) }}>
