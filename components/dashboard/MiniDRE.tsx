          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{
                  fontWeight: 700, fontFamily: "'Manrope', 'Inter', sans-serif",
                  color: negateDisplay && v > 0 ? 'var(--fo-red)' : displayVal >= 0 ? 'var(--fo-green)' : 'var(--fo-red)',
                }}>
                  {fmt(displayVal)}
                </span>
                {varPct === null ? (
                  <span style={{ fontSize: 9, background: 'rgba(94,140,135,.1)', color: 'var(--teal2)', padding: '1px 5px', borderRadius: 20, fontFamily: "'Manrope', 'Inter', sans-serif" }}>1º mês</span>
                ) : (
                  <span style={{
                    fontSize: 9, fontFamily: "'Manrope', 'Inter', sans-serif",
