    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
      ...
      <div style={{ ...card, gridColumn: 'span 2' }}>
        ...
        <div style={{ display: 'flex', gap: 24 }}>
          <div>
            <div style={{ fontSize: 10, color: 'var(--gray-400)', textTransform: 'uppercase', fontFamily: "'Manrope', system-ui, sans-serif" }}>% Conciliado</div>
            <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--green)' }}>{stats?.percentual?.toFixed(1) || '0'}%</div>
          </div>
          <div>
            <div style={{ fontSize: 10, color: 'var(--gray-400)', textTransform: 'uppercase', fontFamily: "'Manrope', system-ui, sans-serif" }}>Conciliados</div>
            <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--navy)' }}>{stats?.conciliados || 0}</div>
          </div>
          <div>
            <div style={{ fontSize: 10, color: 'var(--gray-400)', textTransform: 'uppercase', fontFamily: "'Manrope', system-ui, sans-serif" }}>Não conciliados</div>
            <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--gold)' }}>{stats?.nao_conciliados || 0}</div>
          </div>
          {sugestoes.length > 0 && (
            <div>
              <div style={{ fontSize: 10, color: 'var(--gray-400)', textTransform: 'uppercase', fontFamily: "'Manrope', system-ui, sans-serif" }}>Sugestões fuzzy</div>
