    ...
    <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: 0, minHeight: 580, borderRadius: 16, overflow: 'hidden', border: '1px solid var(--gray-100)', boxShadow: '0 4px 24px rgba(0,0,0,.06)' }}>
      ...
      <div style={{ background: 'var(--navy)', padding: '36px 28px', display: 'flex', flexDirection: 'column' }}>
        <div style={{ marginBottom: 32 }}>
          <div style={{ fontFamily: "'Sora',sans-serif", fontSize: 22, fontWeight: 800, color: '#fff', letterSpacing: '-0.02em' }}>
      ...
      <div style={{ background: '#fff', padding: '36px 32px', display: 'flex', flexDirection: 'column' }}>
        ...
        {etapa === 1 && (
          <div style={{ flex: 1 }}>
            <h3 style={{ fontFamily: "'Sora',sans-serif", fontSize: 18, fontWeight: 700, color: 'var(--navy)', marginBottom: 6 }}>Dados da empresa</h3>
        ...
        {etapa === 2 && (
          <div style={{ flex: 1 }}>
            <h3 style={{ fontFamily: "'Sora',sans-serif", fontSize: 18, fontWeight: 700, color: 'var(--navy)', marginBottom: 6 }}>Quadro societário</h3>
        ...
        {etapa === 3 && (
          <div style={{ flex: 1 }}>
            <h3 style={{ fontFamily: "'Sora',sans-serif", fontSize: 18, fontWeight: 700, color: 'var(--navy)', marginBottom: 6 }}>Documentos</h3>
        ...
        {etapa === 4 && (
          <div style={{ flex: 1 }}>
            <h3 style={{ fontFamily: "'Sora',sans-serif", fontSize: 18, fontWeight: 700, color: 'var(--navy)', marginBottom: 6 }}>Escolha seu plano</h3>
