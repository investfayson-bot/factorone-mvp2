  ...
  return (
    <div className="modal-bg" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal-box" style={{ maxWidth: 680, maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            {TIPOS_ATIVO.map((t) => (
              <button
                ...
                style={{
                  ...
                  background: tipoAtivo === t.value ? 'rgba(0,168,150,0.08)' : '#fafafa',
        ...
        {/* Preview depreciação */}
        {valor > 0 && (
          <div style={{ margin: '16px 0', padding: 14, borderRadius: 10, background: 'rgba(0,168,150,0.06)', border: '1px solid rgba(0,168,150,0.2)' }}>
