...
export const MARKET_APPS: MarketApp[] = [
  { id: 'classificar', name: 'Classificação IA',    icon: 'fa-layer-group',        iconColor: '#3D7A6E', iconBg: '#E9F0ED', rating: 4.9, rev: 148, desc: 'Caixa única banco+cartão. A IA categoriza, aprende com você e classifica sozinha.', badge: 'new', cat: 'financeiro', navGroup: 'Financeiro', href: '/dashboard/classificar', hasPage: true },
  { id: 'cfoia',       name: 'CFO IA',              icon: 'fa-robot',              iconColor: '#2B564D', iconBg: '#E9F0ED', rating: 5.0, rev: 176, desc: 'Analisa seus números, projeta o caixa e gera relatório — um CFO digital.',        badge: 'popular', cat: 'financeiro', navGroup: 'Visão geral',       href: '/dashboard/agentes/acessor', hasPage: true },
  ...
  { id: 'agenda',      name: 'Agendamento',         icon: 'fa-calendar-check',     iconColor: '#3D7A6E', iconBg: '#E9F0ED', rating: 4.9, rev: 71,  desc: 'Link público (tipo Calendly). Cliente marca sozinho → vira lead + reunião no CRM.', badge: 'new', cat: 'vendas', navGroup: 'Clientes & Vendas', href: '/dashboard/agenda', hasPage: true },
  ...
  { id: 'mkt',       name: 'Marketing',              icon: 'fa-bullhorn',           iconColor: '#C2410C', iconBg: '#FFEDD5', rating: 4.7, rev: 105, desc: 'Automatize campanhas de email e anúncios.',         badge: 'new',     cat: 'vendas',      navGroup: 'Marketing',              href: '/dashboard/marketing/central',  hasPage: true  },
  ...
  { id: 'invest',    name: 'Investimentos',          icon: 'fa-chart-line',         iconColor: '#166534', iconBg: '#DCFCE7', rating: 4.8, rev: 71,  desc: 'Carteira de investimentos da empresa: aplicado, rendimento e vencimentos.', badge: 'new', cat: 'financeiro', navGroup: 'Investimentos', href: '/dashboard/conta-pj/investimentos', hasPage: true },
  ...
  { id: 'payroll',   name: 'Folha de Pagamento',     icon: 'fa-users-gear',         iconColor: '#6B21A8', iconBg: '#EDE9FE', rating: 4.7, rev: 98,  desc: 'Holerites, encargos, eSocial e FGTS.',              badge: 'popular', cat: 'rh',          navGroup: 'RH',          href: '/dashboard/folha',              hasPage: true  },
