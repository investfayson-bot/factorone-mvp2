...
export const MARKET_APPS: MarketApp[] = [
  ...
  { id: 'invest',    name: 'Investimentos',          icon: 'fa-chart-line',         iconColor: '#166534', iconBg: '#DCFCE7', rating: 4.8, rev: 71,  desc: 'Carteira de investimentos da empresa: aplicado, rendimento e vencimentos.', badge: 'new', cat: 'financeiro', navGroup: 'Banco PJ', href: '/dashboard/conta-pj/investimentos', hasPage: true },
