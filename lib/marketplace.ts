...
export const MARKET_APPS: MarketApp[] = [
  ...
  { id: 'produtos',    name: 'Produtos & Margem',    icon: 'fa-tags',               iconColor: '#0E7490', iconBg: '#CFFAFE', rating: 4.9, rev: 44,  desc: 'Custo de matéria-prima × preço = quanto sobra em cada venda. Registrar venda cai no DRE (receita + CMV).', badge: 'new', cat: 'financeiro', navGroup: 'Gestão financeira', href: '/dashboard/produtos', hasPage: true },
