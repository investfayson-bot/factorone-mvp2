import * as XLSX from'xlsx-js-style'export type RespostaData = {
 resumo: string
 status: string
...
export function exportExcel(data: RespostaData, pergunta: string) {
 ...
 const navy ='1C2B2A'const teal ='2D9B6F'const gold ='B8922A'const lightGray ='F5F6F5'const white ='FFFFFF'const red ='C0504A'const green ='2D9B6F'let r = 0
