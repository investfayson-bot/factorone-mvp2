            ...
            return (
              <div key={item.id} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 0', borderBottom: idx < pendentes.length - 1 ? '1px solid var(--gray-100)' : 'none', opacity: bloqueado ? 0.5 : 1, transition: 'opacity .2s' }}>
                ...
                <div style={{ textAlign: 'right', marginRight: 8 }}>
                  <div style={{ fontWeight: 700, fontFamily: "'DM Mono',monospace", fontSize: 14, color: 'var(--navy)' }}>{formatBRL(Number(item.valor))}</div>
              ...
              <tbody>
                ...
                {historico.map(h => (
                  <tr key={h.id}>
                    ...
                    <td style={{ textAlign: 'right', fontFamily: "'DM Mono',monospace", fontWeight: 700, fontSize: 12 }}>{formatBRL(Number(h.valor))}</td>
