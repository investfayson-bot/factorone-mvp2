  ...
  return (
    <div>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
        <div>
          <h1 style={{ fontSize:18, fontWeight:700, fontFamily: "'Space Grotesk', system-ui, sans-serif", margin:0 }}>Invoices & Billing</h1>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:10, marginBottom:14 }}>
        {[
          ...
          <div key={l} style={S.card}>
            ...
            <div style={{ fontSize:22, fontWeight:800, fontFamily: "'Space Grotesk', system-ui, sans-serif", color:c }}>{v}</div>
          </div>
        ))}
      </div>
        ...
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,.75)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:1000, padding:20 }} onClick={e=>e.target===e.currentTarget&&setModal(false)}>
          <div style={{ background:'#111A19', border:'1px solid #2E3D3B', borderRadius:14, padding:24, width:460, maxWidth:'95vw' }}>
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:16 }}>
              <span style={{ fontSize:15, fontWeight:700, fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>Nova Invoice</span>
