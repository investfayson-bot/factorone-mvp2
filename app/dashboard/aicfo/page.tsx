      ...
      <div className="kpis" style={{ gridTemplateColumns: 'repeat(5,1fr)', marginBottom: 16 }}>
        ...
        <div className="kpi" style={{ borderTop: '3px solid #E74C3C' }}>
          <div className="kpi-lbl">Despesas mês
            <div style={{ width: 26, height: 26, borderRadius: 7, background: '#FEE2E2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <i className="fa-solid fa-arrow-trend-down" style={{ fontSize: 11, color: '#E74C3C' }} />
            </div>
          </div>
        ...
        <div className="ai-chat">
          ...
          {mensagens.length === 0 && (
            <div style={{ padding: '14px 0 6px' }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: '#7A8F8E', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>Ações rápidas</div>
