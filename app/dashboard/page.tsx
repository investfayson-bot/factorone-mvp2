        ...
        <Link href="/dashboard/clientes" style={{ textDecoration: 'none', display: 'block', marginBottom: 12 }}>
          <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, padding: '12px 18px', display: 'flex', alignItems: 'center', gap: 20, cursor: 'pointer' }}>
            ...
            <div style={{ flex: 1, display: 'flex', gap: 28, flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <div><div style={{ fontSize: 10, color: 'var(--gray-400)' }}>MRR Contratos</div><div style={{ fontWeight: 700, color: 'var(--teal)', fontFamily: "'Inter', sans-serif" }}>{fmtBRLCompact(clientesWidget.mrr)}</div></div>
            </div>
              ...
              <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, padding: '14px 16px', cursor: 'pointer', height: '100%' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Inter', sans-serif" }}>{fmtBRLCompact(crmWidget.pipeline)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 10, color: 'var(--gray-400)', marginBottom: 2 }}>Ganho</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--green)', fontFamily: "'Inter', sans-serif" }}>{fmtBRLCompact(crmWidget.ganhaMes)}</div>
                  </div>
                  <div>
              ...
              <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, padding: '14px 16px', cursor: 'pointer', height: '100%' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--red)', fontFamily: "'Inter', sans-serif" }}>{fmtBRLCompact(mktWidget.gasto)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 10, color: 'var(--gray-400)', marginBottom: 2 }}>Receita</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--green)', fontFamily: "'Inter', sans-serif" }}>{fmtBRLCompact(mktWidget.receita)}</div>
                  </div>
                  <div>
              ...
              <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, padding: '14px 16px', cursor: 'pointer', height: '100%' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--teal)', fontFamily: "'Inter', sans-serif" }}>{fmtBRLCompact(logWidget.receitaFrete)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 10, color: 'var(--gray-400)', marginBottom: 2 }}>Entregues/mês</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--green)', fontFamily: "'Inter', sans-serif" }}>{logWidget.entreguesMes}</div>
                  </div>
                  <div>
      ...
      {score && (
        <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, padding: '14px 18px', marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, cursor: 'pointer' }} onClick={() => setScoreExpanded(v => !v)}>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--gray-400)', letterSpacing: '.08em', textTransform: 'uppercase', fontFamily: "'Inter', sans-serif", marginBottom: 4 }}>
                Score Financeiro FactorOne
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ fontSize: 28, fontWeight: 800, color: score.total >= 700 ? 'var(--green)' : score.total >= 500 ? 'var(--gold)' : 'var(--red)', fontFamily: "'Inter', sans-serif" }}>
                  {score.total}
                </div>
              ...
              {score.componentes.map(c => (
                <div key={c.nome} style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ position: 'relative', width: 52, height: 52, margin: '0 auto 6px' }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Inter', sans-serif" }}>{c.pontos}</div>
                  </div>
