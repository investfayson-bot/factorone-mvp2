...
// Squad de agentes nomeados + atividade/custo real registrado por eles.
// Não é uma das 3 sub-abas da Fase 4 (Acessor/Conversas/Automações) — fica
// como visão extra, linkada a partir da Automações, seguindo o mesmo padrão
// usado em /dashboard/relatorios (Fase 2): conteúdo útil que não tinha
// mapeamento 1:1 na spec, mantido standalone em vez de descartado.
...
export default function AtividadeAgentesPage() {
  ...
  return (
    <>
      <div className="page-hdr">
        <div>
          <div className="page-title">Atividade & custos</div>
