                  ...
                  {loading ? (
                    ...
                    return (
                      <tr key={t.id}>
                        ...
                        <td style={{ textAlign: 'right', fontWeight: 700, fontFamily: "var(--font-sans)", color: t.tipo === 'entrada' ? 'var(--green)' : 'var(--red)' }}>
                          {t.tipo === 'entrada' ? '+' : '-'}{fmt(Number(t.valor))}
                        </td>
                        <td style={{ textAlign: 'right', fontFamily: "var(--font-sans)", color: 'var(--navy)' }}>{fmt(saldoRow)}</td>
                      </tr>
                    )
                  })}
                </tbody>
