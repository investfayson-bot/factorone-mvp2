                  ...
                  {loading ? (
                    ...
                    return (
                      <tr key={t.id}>
                        ...
                        <td style={{ textAlign: 'right', fontWeight: 700, fontFamily: "'Manrope', system-ui, sans-serif", color: t.tipo === 'entrada' ? 'var(--green)' : 'var(--red)' }}>
                          {t.tipo === 'entrada' ? '+' : '-'}{fmt(Number(t.valor))}
                        </td>
                        <td style={{ textAlign: 'right', fontFamily: "'Manrope', system-ui, sans-serif", color: 'var(--navy)' }}>{fmt(saldoRow)}</td>
                      </tr>
                    )
                  })}
                </tbody>
          ...
          {insightIA && (
            <div style={{ background: 'rgba(94,140,135,.06)', border: '1px solid rgba(94,140,135,.2)', borderRadius: 12, padding: '16px 18px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--teal2)', letterSpacing: '.08em', textTransform: 'uppercase', fontFamily: "'Manrope', system-ui, sans-serif" }}>FactorOne IA — Análise de Fluxo</div>
      ...
      {activeTab === 2 && (
        <>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, alignItems: 'start' }}>
            ...
            <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, overflow: 'hidden' }}>
              <div style={{ padding: '10px 14px', borderBottom: '1px solid var(--gray-100)', fontSize: 11, fontWeight: 700, color: 'var(--navy)', letterSpacing: '.04em', textTransform: 'uppercase', fontFamily: "'Manrope', system-ui, sans-serif" }}>
