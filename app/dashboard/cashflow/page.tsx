                  ...
                  {loading ? (
                    ...
                    return (
                      <tr key={t.id}>
                        ...
                        <td style={{ textAlign: 'right', fontWeight: 700, fontFamily: "'Inter', system-ui, sans-serif", color: t.tipo === 'entrada' ? 'var(--green)' : 'var(--red)' }}>
                          {t.tipo === 'entrada' ? '+' : '-'}{fmt(Number(t.valor))}
                        </td>
                        <td style={{ textAlign: 'right', fontFamily: "'Inter', system-ui, sans-serif", color: 'var(--navy)' }}>{fmt(saldoRow)}</td>
                      </tr>
                    )
                  })}
                </tbody>
      ...
      {activeTab === 2 && (
        <>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, alignItems: 'start' }}>
            ...
            <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 12, overflow: 'hidden' }}>
              <div style={{ padding: '10px 14px', borderBottom: '1px solid var(--gray-100)', fontSize: 11, fontWeight: 700, color: 'var(--navy)', letterSpacing: '.04em', textTransform: 'uppercase', fontFamily: "'Inter', system-ui, sans-serif" }}>
