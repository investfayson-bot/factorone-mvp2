...
export default function ContaPJPage() {
  ...
  if (wSuccess) return (
    <div style={{ maxWidth: 520, margin: '40px auto', padding: '0 16px', textAlign: 'center' }}>
      ...
      <div style={{ fontSize: 24, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", marginBottom: 8 }}>
    ...
    <div style={{ maxWidth: wStep === 5 ? 900 : 640, margin: '0 auto', padding: '24px 16px' }}>
      ...
      {wStep === 1 && (
        <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 14, padding: '28px 32px' }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", marginBottom: 4 }}>Informações da empresa</div>
      ...
      {wStep === 2 && (
        <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 14, padding: '28px 32px' }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", marginBottom: 4 }}>Dados dos responsáveis</div>
      ...
      {wStep === 3 && (
        <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 14, padding: '28px 32px' }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", marginBottom: 4 }}>Endereço da empresa</div>
      ...
      {wStep === 4 && (
        <div style={{ background: '#fff', border: '1px solid var(--gray-100)', borderRadius: 14, padding: '28px 32px' }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", marginBottom: 4 }}>Documentos</div>
  ...
  return (
    <>
      ...
      <div className="page-hdr" style={{ flexWrap: 'wrap', gap: 12 }}>
        <div>
          <div style={{ fontSize: 20, fontWeight: 800, color: 'var(--navy)', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
