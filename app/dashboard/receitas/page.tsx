          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {porCategoria.map(([cat, val]) => (
              <div key={cat} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div style={{ fontSize: 12, fontWeight: 700, fontFamily: "'Inter', sans-serif", minWidth: 90, textAlign: 'right' }}>{formatBRL(val)}</div>
            ...
            <tbody>
              ...
              {filtradas.map(r => (
                <tr key={r.id} style={{ opacity: r.status === 'cancelada' ? 0.5 : 1 }}>
                  ...
                  <td style={{ textAlign: 'right', fontFamily: "'Inter', sans-serif", color: 'var(--green)', fontWeight: 700, fontSize: 13 }}>
