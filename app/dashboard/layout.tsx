...
const menu = [
  ...
  { href: '/dashboard/patrimonio?tab=ativos', icon: Building2, label: 'Patrimônio • Ativos', group: 'financeiro' },
  { href: '/dashboard/patrimonio?tab=depreciacao', icon: Building2, label: 'Patrimônio • Depreciação', group: 'financeiro' },
  { href: '/dashboard/patrimonio?tab=manutencoes', icon: Building2, label: 'Patrimônio • Manutenções', group: 'financeiro' },
