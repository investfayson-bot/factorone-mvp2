  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/dashboard/clientes-vendas/visao-geral', icon: 'fa-users', label: 'Clientes & Vendas', match: (p) => p.startsWith('/dashboard/clientes-vendas') },
        { href: '/dashboard/contabil-fiscal/visao-geral', icon: 'fa-file-invoice-dollar', label: 'Contábil & Fiscal', match: (p) => p.startsWith('/dashboard/contabil-fiscal') },
        { href: '/dashboard/marketing/visao-geral', icon: 'fa-bullhorn', label: 'Marketing', match: (p) => p.startsWith('/dashboard/marketing') },
      ],
    },
    {
      label: 'EXTRAS',
...
const pageTitles: Record<string, string> = {
  ...
  '/dashboard/clientes-vendas/visao-geral': 'Clientes & Vendas',
  '/dashboard/clientes-vendas/pipeline': 'Pipeline',
  '/dashboard/clientes-vendas/agendamento': 'Agendamento',
  '/dashboard/clientes-vendas/propostas': 'Propostas',
  '/dashboard/clientes-vendas/pos-venda': 'Pós-venda',
  '/dashboard/clientes-vendas/ofertas': 'Dashboard de Ofertas',
  '/dashboard/crm': 'CRM',
  '/dashboard/contabil-fiscal/visao-geral': 'Contábil & Fiscal',
  '/dashboard/contabil-fiscal/obrigacoes': 'Obrigações',
  '/dashboard/contabil-fiscal/impostos-regime': 'Impostos & Regime',
  '/dashboard/contabil-fiscal/cofre-fiscal': 'Cofre Fiscal',
  '/dashboard/contabil-fiscal/portal-contador': 'Portal do Contador',
  '/dashboard/contabilidade/livros': 'Livros contábeis',
  '/dashboard/marketing/visao-geral': 'Marketing',
  '/dashboard/marketing/calendario': 'Calendário Editorial',
  '/dashboard/marketing/trafego': 'Tráfego Pago',
  '/dashboard/marketing/campanhas': 'Campanhas',
  '/dashboard/marketing/email': 'E-mail Marketing',
  '/dashboard/banco/patrimonio': 'Patrimônio',
  '/dashboard/marketing/central': 'Marketing (Central)',
