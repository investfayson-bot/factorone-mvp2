...
const menu = [
  ...
  { href: '/dashboard/patrimonio', icon: Building2, label: 'Patrimônio', group: 'financeiro' },
  { href: '/dashboard/orcamento', icon: BarChart3, label: 'Orçamento', group: 'financeiro' },
  { href: '/dashboard/orcamento?tab=geral', icon: BarChart3, label: 'Orçamento • Visão Geral', group: 'financeiro' },
  { href: '/dashboard/orcamento?tab=categoria', icon: BarChart3, label: 'Orçamento • Por Categoria', group: 'financeiro' },
  { href: '/dashboard/orcamento?tab=alertas', icon: BarChart3, label: 'Orçamento • Alertas', group: 'financeiro' },
