  ...
  return (
    <>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 14 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Inter', sans-serif" }}>Parâmetros</div>
              {[
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            {comparativo.length > 0 && (
              <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 4, fontFamily: "'Inter', sans-serif" }}>Price vs SAC — parcelas (primeiros 12 meses)</div>
            ...
            {tabela.length > 0 && (
              <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, overflow: 'hidden' }}>
                <div style={{ padding: '12px 16px', borderBottom: '0.5px solid #E2E8E7', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#F8FAFA' }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Inter', sans-serif" }}>Tabela de amortização — {sistema.toUpperCase()}</div>
      ...
      {modo === 'consorcio' && (
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 14 }}>
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Inter', sans-serif" }}>Simular consórcio</div>
            {[
      ...
      {modo === 'credito_giro' && (
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 14 }}>
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Inter', sans-serif" }}>Dados da empresa</div>
            {[
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Inter', sans-serif" }}>Linhas recomendadas para sua empresa</div>
      ...
      {modo === 'comparativo' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {/* Gráfico comparativo */}
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 4, fontFamily: "'Inter', sans-serif" }}>Taxas de crédito no mercado (Junho 2026)</div>
          ...
          {/* Estratégias */}
          <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Inter', sans-serif" }}>Estratégias para conseguir mais crédito</div>
