  ...
  return (
    <>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 14 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Space Grotesk', sans-serif" }}>Parâmetros</div>
              {[
                ...
                <div key={f.label} style={{ marginBottom: 12 }}>
                  ...
                  <input className="form-input" type="number" placeholder={f.placeholder} value={f.value} onChange={e => f.set(e.target.value)} style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600 }} />
                </div>
              ))}
              <div>
              ...
              <div style={{ background: '#1C2B2A', borderRadius: 14, padding: '16px 18px' }}>
                ...
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0', borderBottom: '0.5px solid rgba(255,255,255,.06)' }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 700, color: item.cor, fontFamily: "'Space Grotesk', sans-serif" }}>{item.val}</span>
                  </div>
                ))}
              </div>
            )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            {comparativo.length > 0 && (
              <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 4, fontFamily: "'Space Grotesk', sans-serif" }}>Price vs SAC — parcelas (primeiros 12 meses)</div>
            ...
            {tabela.length > 0 && (
              <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, overflow: 'hidden' }}>
                <div style={{ padding: '12px 16px', borderBottom: '0.5px solid #E2E8E7', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#F8FAFA' }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Space Grotesk', sans-serif" }}>Tabela de amortização — {sistema.toUpperCase()}</div>
                ...
                <div style={{ maxHeight: 300, overflowY: 'auto' }}>
                  {tabela.slice(0, 24).map((r, i) => (
                    <div key={r.mes} style={{ display: 'grid', gridTemplateColumns: '60px 1fr 1fr 1fr 1fr', padding: '8px 16px', borderBottom: i < Math.min(24, tabela.length) - 1 ? '0.5px solid #F0F4F3' : 'none', alignItems: 'center' }}>
                      <div style={{ fontSize: 11, color: '#7A8F8E', fontFamily: "'Space Grotesk', sans-serif" }}>{r.mes}</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Space Grotesk', sans-serif" }}>{formatBRL(r.parcela)}</div>
                      <div style={{ fontSize: 11, color: '#E74C3C', fontFamily: "'Space Grotesk', sans-serif" }}>{formatBRL(r.juros)}</div>
                      <div style={{ fontSize: 11, color: '#5E8C87', fontFamily: "'Space Grotesk', sans-serif" }}>{formatBRL(r.amortizacao)}</div>
                      <div style={{ fontSize: 11, color: '#7A8F8E', fontFamily: "'Space Grotesk', sans-serif" }}>{formatBRL(r.saldo)}</div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {modo === 'consorcio' && (
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 14 }}>
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Space Grotesk', sans-serif" }}>Simular consórcio</div>
            {[
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 12, fontFamily: "'Space Grotesk', sans-serif" }}>Pontos importantes sobre consórcio</div>
              {[
      ...
      {modo === 'credito_giro' && (
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 14 }}>
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Space Grotesk', sans-serif" }}>Dados da empresa</div>
            {[
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Space Grotesk', sans-serif" }}>Linhas recomendadas para sua empresa</div>
              {TAXAS_MERCADO.filter(t => t.tipo === 'Empresa').map(linha => (
                <div key={linha.nome} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9px 0', borderBottom: '0.5px solid #F0F4F3' }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: 14, fontWeight: 700, color: linha.taxa > 2 ? '#D97706' : '#5E8C87', fontFamily: "'Space Grotesk', sans-serif" }}>{linha.taxa}%/mês</div>
      ...
      {modo === 'comparativo' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {/* Gráfico comparativo */}
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 4, fontFamily: "'Space Grotesk', sans-serif" }}>Taxas de crédito no mercado (Junho 2026)</div>
          ...
          {/* Estratégias */}
          <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Space Grotesk', sans-serif" }}>Estratégias para conseguir mais crédito</div>
