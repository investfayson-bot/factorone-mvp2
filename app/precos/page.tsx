    ...
    <div style={{ minHeight: '100vh', background: '#F4F6F5', fontFamily: "'Manrope', 'Inter', sans-serif" }}>
      ...
      <nav style={{ background: '#1C2B2A', padding: '0 28px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Link href="/" style={{ textDecoration: 'none' }}>
          <div style={{ fontSize: 20, fontWeight: 800, color: '#fff', fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '-0.03em' }}>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '48px 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 36, fontWeight: 800, color: '#1C2B2A', letterSpacing: '-0.03em', margin: '0 0 12px', fontFamily: "'Space Grotesk', sans-serif", lineHeight: 1.15 }}>
          ...
          {planos.map(p => {
            ...
            return (
              <div key={p.key} style={{
                ...
                <div style={{ fontSize: 15, fontWeight: 700, color: '#1C2B2A', marginBottom: 4, fontFamily: "'Space Grotesk', sans-serif" }}>{p.nome}</div>
                <div style={{ fontSize: 28, fontWeight: 800, color: '#1C2B2A', letterSpacing: '-0.04em', lineHeight: 1, fontFamily: "'Space Grotesk', sans-serif" }}>{p.preco}</div>
        ...
        <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '24px 28px', marginBottom: 40 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: '#1C2B2A', marginBottom: 20, fontFamily: "'Space Grotesk', sans-serif" }}>O que está incluído em todos os planos</div>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ fontSize: 20, fontWeight: 700, color: '#1C2B2A', textAlign: 'center', marginBottom: 24, fontFamily: "'Space Grotesk', sans-serif" }}>Perguntas frequentes</div>
        ...
        <div style={{ background: '#1C2B2A', borderRadius: 16, padding: '36px 40px', textAlign: 'center' }}>
          <div style={{ fontSize: 24, fontWeight: 800, color: '#fff', marginBottom: 10, fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '-0.02em' }}>
          ...
          <Link href="/auth" style={{ textDecoration: 'none', display: 'inline-block', background: '#5E8C87', color: '#fff', padding: '13px 32px', borderRadius: 10, fontSize: 14, fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <footer style={{ background: '#1C2B2A', padding: '20px 28px', marginTop: 40 }}>
        <div style={{ maxWidth: 960, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
          <div style={{ fontSize: 14, fontWeight: 800, color: '#fff', fontFamily: "'Space Grotesk', sans-serif" }}>
            Factor<span style={{ color: '#7EBDB8' }}>One</span>
          </div>
