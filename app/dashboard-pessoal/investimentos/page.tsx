      ...
      {tab === 'visao' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 14 }}>
          ...
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Inter', sans-serif" }}>Alocação por classe</div>
            {pieData.length === 0 ? (
          ...
          {/* Evolução */}
          <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '16px 18px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#1C2B2A', marginBottom: 14, fontFamily: "'Inter', sans-serif" }}>Evolução patrimonial</div>
            {totalAtual === 0 ? (
          ...
          {porClasse.map(c => (
            <div key={c.cls} style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '14px 16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Inter', sans-serif" }}>{c.info.label}</div>
                  ...
                  <div key={inv.id} style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 100px', padding: '11px 16px', borderBottom: i < itensFiltrados.length - 1 ? '0.5px solid #F0F4F3' : 'none', alignItems: 'center' }}>
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                        {inv.ticker && <span style={{ background: '#EEF2F1', borderRadius: 4, padding: '1px 5px', fontSize: 9, fontWeight: 700, color: '#1C2B2A', fontFamily: "'Inter', sans-serif" }}>{inv.ticker}</span>}
