...
export default function PlanosPFPage() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
            ...
            <div key={p.key} style={{
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 12, fontWeight: 700, cursor: ativo ? 'default' : 'pointer', border: 'none',
      ...
      <div style={{ background: '#1C2B2A', borderRadius: 14, padding: '20px 24px', marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{ width: 52, height: 52, borderRadius: 12, background: 'rgba(94,140,135,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <i className="fa-solid fa-building" style={{ fontSize: 22, color: '#7EBDB8' }} />
            </div>
            <div>
              <div style={{ fontSize: 14, fontWeight: 700, color: '#fff', marginBottom: 5 }}>
                Tem uma empresa? Abra sua Conta PJ
              </div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', lineHeight: 1.6, maxWidth: 460 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, flexShrink: 0 }}>
            <button
              ...
              style={{ background: '#5E8C87', color: '#fff', border: 'none', borderRadius: 9, padding: '10px 20px', fontSize: 12, fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap' }}
            >
              Ver planos PJ
            </button>
            <button
              onClick={() => router.push('/dashboard/planos?tab=familia')}
              style={{ background: 'rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.7)', border: '0.5px solid rgba(255,255,255,0.15)', borderRadius: 9, padding: '8px 20px', fontSize: 11, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap' }}
            >
      ...
      <div style={{ background: '#fff', border: '0.5px solid #E2E8E7', borderRadius: 14, padding: '18px 20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            ...
            <div key={item.q} style={{ borderBottom: '0.5px solid #F0F4F3', paddingBottom: 12 }}>
