    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: '#F5F7FA' }}>
      ...
      {showSidebar && (
        <aside style={{ width: 260, background: 'var(--navy)', display: 'flex', flexDirection: 'column', padding: '32px 24px', flexShrink: 0 }}>
          {/* Logo */}
          <div style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontSize: 20, fontWeight: 800, color: '#fff', letterSpacing: '-.04em', marginBottom: 6 }}>
      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 24px' }}>
        ...
        {screen === 'splash' && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: 560, width: '100%', textAlign: 'center' }}>
            ...
            {/* Logo */}
            <div style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontSize: 13, fontWeight: 600, color: 'var(--gray-400)', letterSpacing: '.06em', textTransform: 'uppercase', marginBottom: 8 }}>
              Finance OS
            </div>
            <div style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontSize: 28, fontWeight: 800, color: 'var(--navy)', letterSpacing: '-.03em', marginBottom: 6 }}>
        ...
        {screen === 'perfil' && (
          <div style={{ width: '100%', maxWidth: 600 }}>
            <div style={{ marginBottom: 28 }}>
              <div style={{ fontSize: 22, fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontWeight: 800, color: 'var(--navy)', marginBottom: 6 }}>Como você vai usar o FactorOne?</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              >
                ...
                <div style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontSize: 16, fontWeight: 700, color: 'var(--navy)', marginBottom: 4 }}>Empresarial (PJ)</div>
              ...
              >
                ...
                <div style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontSize: 16, fontWeight: 700, color: 'var(--navy)', marginBottom: 4 }}>Pessoa Física</div>
        ...
        {screen === 'empresa' && (
          <div style={{ width: '100%', maxWidth: 520 }}>
            <div style={{ marginBottom: 28 }}>
              <div style={{ fontSize: 22, fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontWeight: 800, color: 'var(--navy)', marginBottom: 6 }}>Quais são os dados da sua empresa?</div>
        ...
        {screen === 'financeiro' && (
          <div style={{ width: '100%', maxWidth: 520 }}>
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 22, fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontWeight: 800, color: 'var(--navy)', marginBottom: 6 }}>Traga seus dados financeiros</div>
        ...
        {screen === 'pronto' && (
          <div style={{ maxWidth: 480, width: '100%', textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif", fontSize: 24, fontWeight: 800, color: 'var(--navy)', marginBottom: 6 }}>
